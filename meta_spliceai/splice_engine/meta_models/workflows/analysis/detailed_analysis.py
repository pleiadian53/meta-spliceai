...
def answer_question_1_donor_acceptor_asymmetry():
    ...
    print("1. **Different Recognition Mechanisms**:")
    print("   • Donor sites (5' splice sites): GT dinucleotide with context on both sides of exon-intron junction")
    print("   • Acceptor sites (3' splice sites): Rely primarily on upstream intronic elements (branchpoint + polypyrimidine tract) plus AG at junction")
    print("   • Different recognition requirements → different boundary processing")
    print()
    
    print("2. **Asymmetric Splicing Biology**:")
    print("   • Donor recognition: Depends on both exonic and intronic sequences at junction")
    print("   • Acceptor recognition: Primarily upstream intronic architecture with junction AG")
    print("   • Spliceosome assembly is directionally asymmetric with different context dependencies")
    print()
