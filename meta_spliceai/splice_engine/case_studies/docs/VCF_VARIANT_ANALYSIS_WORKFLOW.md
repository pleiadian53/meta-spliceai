...
**📍 Document Location**: Now located in `meta_spliceai/splice_engine/case_studies/docs/` for easier access and maintenance alongside related case study documentation.

**🔗 Related Documentation**:
- [ClinVar Workflow Steps 1-2 Tutorial](tutorials/CLINVAR_WORKFLOW_STEPS_1_2_TUTORIAL.md) - Hands-on tutorial with enhanced coordinate validation
- [VCF Analysis Tools Guide](VCF_ANALYSIS_TOOLS_GUIDE.md) - Tool-specific documentation
...
```
Raw VCF → VCF Normalization → Coordinate Validation → Variant Parsing → Sequence Construction → 
